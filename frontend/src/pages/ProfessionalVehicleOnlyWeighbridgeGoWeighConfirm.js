...
const ProfessionalVehicleOnlyWeighbridgeGoWeighConfirm = () => {
  ...
  useEffect(() => {
    ...
    console.log('🧭 confirm hydration (goweigh) state caravanFromLookup:', stateData.caravanFromLookup);
    console.log('🧭 confirm hydration (goweigh) resolved caravan.complianceImage:', caravan?.complianceImage);
    console.log('🧭 confirm hydration (goweigh) weighingSelection:', stateData.weighingSelection);
  ...
  useEffect(() => {
    ...
    const fetchCaravanIfMissing = async () => {
      try {
        ...
        console.log('🌐 fallback caravan lookup (goweigh confirm)', {
          rego: regoToLookup,
          state: stateToLookup,
        });
        ...
        console.log('🌐 fallback caravan lookup response (goweigh confirm)', response.data);
        ...
        console.error('Fallback caravan lookup failed (goweigh confirm):', error?.response?.data || error);
      }
    };
