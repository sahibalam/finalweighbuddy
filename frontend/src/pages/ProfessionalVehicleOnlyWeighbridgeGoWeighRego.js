...
const ProfessionalVehicleOnlyWeighbridgeGoWeighRego = () => {
    ...
    try {
      ...
      if (rego) {
        if (weighingSelection === 'caravan_only_registered') {
          ...
          console.log('🔎 caravan lookup response (goweigh)', response.data);
          ...
          if (response.data?.success && response.data?.found) {
            ...
            console.log('✅ caravanFromLookup (goweigh)', lookupCaravan);
          }
        } else {
      ...
      navigate('/professional-vehicle-only-weighbridge-goweigh-confirm', {
        state: {
          rego,
          state,
          vin,
      ...
      console.error('Error looking up vehicle by plate (professional goweigh):', err);
...
export default ProfessionalVehicleOnlyWeighbridgeGoWeighRego;
